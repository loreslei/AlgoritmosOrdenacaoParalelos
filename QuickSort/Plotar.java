...
public class Plotar {
    ...
    public static void main(String[] args) {
        ...
        for (Dado d : dados) {
            if (d.nome.equalsIgnoreCase("Quick Sort Paralelo")) {
        ...
        for (int threads : threadsSet) {
            ...
            List<Dado> paralelos = dados.stream()
                    .filter(d -> d.nome.equalsIgnoreCase("Quick Sort Paralelo") && d.threads == threads)
            ...
            for (Dado p : paralelos) {
                ...
                Optional<Dado> s = dados.stream()
                        .filter(d -> d.nome.equalsIgnoreCase("Quick Sort Serial") && d.tamanho == p.tamanho)
                        .findFirst();
            ...
            String titulo = "Quick Sort - Serial vs Paralelo (" + threads + " Threads)";
