    ...
    public static void main(String[] args) {
        ...
        try (BufferedReader br = new BufferedReader(new FileReader(caminhoCSV))) {
            ...
            while ((linha = br.readLine()) != null) {
                ...
                if (nomeAlgoritmo.equalsIgnoreCase("Bubble Sort Serial")) {
                    tamanhos.add(tamanho);
                    temposSerial.add(tempo);
                } else if (nomeAlgoritmo.equalsIgnoreCase("Bubble Sort Paralelo")) {
            ...
            GeradorGrafico.exibirGrafico("BubbleSort", tamanhosArray, temposSerialArray, temposParaleloArray);
