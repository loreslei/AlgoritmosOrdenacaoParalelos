    ...
    public static void main(String[] args) {
        ...
        try (BufferedReader br = new BufferedReader(new FileReader(caminhoCSV))) {
            ...
            while ((linha = br.readLine()) != null) {
                ...
                if (nomeAlgoritmo.equalsIgnoreCase("Merge Sort Serial")) {
                    tamanhos.add(tamanho);
                    temposSerial.add(tempo);
                } else if (nomeAlgoritmo.equalsIgnoreCase("Merge Sort Paralelo")) {
            ...
            GeradorGrafico.exibirGrafico("MergeSort", tamanhosArray, temposSerialArray, temposParaleloArray);
