...
public class Plotar {
    ...
    public static void main(String[] args) {
        String caminhoCSV = "MergeSort/resultados.csv";
        ...
        for (Dado d : dados) {
            if (d.nome.equalsIgnoreCase("Merge Sort Paralelo")) {
        ...
        for (int threads : threadsSet) {
            ...
            List<Dado> paralelos = dados.stream()
                    .filter(d -> d.nome.equalsIgnoreCase("Merge Sort Paralelo") && d.threads == threads)
            ...
            for (Dado p : paralelos) {
                ...
                Optional<Dado> s = dados.stream()
                        .filter(d -> d.nome.equalsIgnoreCase("Merge Sort Serial") && d.tamanho == p.tamanho)
                        .findFirst();
            ...
            String titulo = "Merge Sort - Serial vs Paralelo (" + threads + " Threads)";
